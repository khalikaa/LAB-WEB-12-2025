...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('price', $product->price)); ?>" required step="0.01">
...
unset($__errorArgs, $__bag); ?>"
                    rows="3"><?php echo e(old('description', $product->detail->description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('weight', $product->detail->weight ?? '')); ?>" required step="0.01">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="size" class="form-control <?php $__errorArgs = ['size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    value="<?php echo e(old('size', $product->detail->size ?? '')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 3\Pemrograman Web  A\Tugas Praktikum\Praktikum-9\resources\views/products/edit.blade.php ENDPATH**/ ?>